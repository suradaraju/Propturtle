...
import "swiper/css";
// import bg2 from "../assets/images/resources/About-Us-02.jpg";
// import bg from "../assets/images/backgrounds/slider-3-1.jpg";
import bg2 from "../assets/images/resources/About-Us-02.jpg";
import bg from "../assets/images/backgrounds/Hero-Image.jpg";
    ...
    <>
      <div className="page-wrapper">
        ...
        <section className="main-slider-two">
          <div
            className="main-slider-two__bg hero-slide"
              ...
              <div className="row">
                <div className="col-xl-8 col-lg-10 offset-lg-1 offset-xl-2">
                  <div className="main-slider-two__content text-center">
                    ...
                    <h1 className="main-slider-two__title animate-up delay-1">
     Invest in Fractional <br/>Real Estate in Hyderabad 


                    </h1>

                    <p className="main-slider-p animate-up delay-2">
             Premium fractional real estate in Hyderabad-built for stable income and long-term growth.
                    </p>

                    <button  onClick={() => window.location.href = "/liveprojects"} className="explore-header-btn animate-up delay-3" target="_blank">
                      Explore Investment Opportunities
                    </button>

                    <p className="head-para animate-up delay-4">
                ...
                <div className="col-xl-12">
                  <div className="offer-room__card">
                    ...
                    <div className="offer-room__card__funfact">
                      ...
                      <p>
                        {/* PropTurtle enables fractional ownership in premium real estate assets. We develop and manage
                        high-quality properties to deliver stablet income, long-term growth, and complete
                        transparency-without the complexity of traditional investing. */}
                        PropTurtle simplifies fractional real estate in Hyderabad by enabling investors to access premium, income-generating commercial and hospitality assets. We identify, develop, and professionally manage high-quality real estate opportunities, allowing investors to own fractional shares in institutional-grade properties designed for stable income and long-term wealth creation.
                      </p>
